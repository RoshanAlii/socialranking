...
async function setup(request,env){
  ...
  if(request.method==='POST'){
    if(request.headers.get('Origin')!==url.origin)return response({error:'Invalid setup origin'},403);
